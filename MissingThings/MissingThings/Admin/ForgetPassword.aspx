                ...
                <div style="margin: 200Px auto; float: none; width: 405Px;">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-user fa-1x"></i>&nbsp;Forgot Password
                        </div>
                        <div class="panel-body" style="padding: 30Px;">
                            <div class="form-group input-group">
                              ...
                              <%--  <asp:RegularExpressionValidator ID="REVEmail" runat="server" Text="*" ControlToValidate="txtUserName"
                                    CssClass="ErrorLabelStyle" ValidationGroup="Login"></asp:RegularExpressionValidator>--%>
                            </div>
                            <div>
                                <div class="fleft">
                                ...
                                <div class="fright">
                                    &nbsp;<asp:Button runat="server" 
                                        ID="btnSend" CssClass="btn btn-success" Text="Send"
                                        ValidationGroup="Login" onclick="btnSend_Click" />
                                </div>
                                <div class="fclear">
                                </div>
