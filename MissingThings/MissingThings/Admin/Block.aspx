<%@ Page Title="Tab List" Language="C#" MasterPageFile="~/Admin/Main.master" AutoEventWireup="true"
    CodeFile="Block.aspx.cs" Inherits="Block" %>
                        ...
                        <ContentTemplate>
                            <div class="panel-search">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFields" CssClass="form-control" TabIndex="3">
                                    <asp:ListItem Text="Block Name" Value="appBlockName"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
                                        OnClientClick="return ConfirmMessage('Block','delete')" OnClick="btnDelete_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        DataKeyNames="appBlockId,appIsShowContent" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <a href='<%# "BlockDetail.aspx?ID=" + objEncrypt.Encrypt(Eval("appBlockId").ToString(), appFunctions.strKey) %>'
                                                        title="Edit"><span class="action-icon set-icon"><i class="fa fa-pencil"></i></span>
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="appBlockName" HeaderText="Block Name" SortExpression="appBlockName" />
                                            <asp:TemplateField HeaderText="Is Show Content" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsShowContent" CommandName="IsShowContent" CommandArgument='<%#Eval("appBlockId") %>'>
                                                        <span class="action-icon set-icon <%# Eval("appIsShowContent").ToString().ToLower() == "true" ? "green" : "red" %>"><i class="fa <%# Eval("appIsShowContent").ToString().ToLower() == "true" ? "fa-check" : "fa-ban" %>"></i></span>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
