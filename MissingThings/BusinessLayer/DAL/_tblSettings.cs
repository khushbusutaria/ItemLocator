...
namespace BusinessLayer
{
	public abstract class _tblSettings : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter AppDisplayMenu
			{
				get
				{
					return new SqlParameter("@AppDisplayMenu", SqlDbType.VarChar, 10);
				}
			}
			
			public static SqlParameter AppIsSSLEnabled
			{
				get
				{
					return new SqlParameter("@AppIsSSLEnabled", SqlDbType.Bit, 0);
				}
			}
		...
		{  
            ...
            public const string AppDisplayMenu = "appDisplayMenu";
            public const string AppIsSSLEnabled = "appIsSSLEnabled";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[AppDisplayMenu] = _tblSettings.PropertyNames.AppDisplayMenu;
					ht[AppIsSSLEnabled] = _tblSettings.PropertyNames.AppIsSSLEnabled;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[AppDisplayMenu] = _tblSettings.ColumnNames.AppDisplayMenu;
					ht[AppIsSSLEnabled] = _tblSettings.ColumnNames.AppIsSSLEnabled;
		...
		{  
            ...
            public const string AppDisplayMenu = "s_AppDisplayMenu";
            public const string AppIsSSLEnabled = "s_AppIsSSLEnabled";
		...
		public virtual string AppDisplayMenu
	    {
			get
	        {
				return base.Getstring(ColumnNames.AppDisplayMenu);
			}
			set
	        {
				base.Setstring(ColumnNames.AppDisplayMenu, value);
			}
		}

		public virtual bool AppIsSSLEnabled
	    {
			get
	        {
				return base.Getbool(ColumnNames.AppIsSSLEnabled);
			}
			set
	        {
				base.Setbool(ColumnNames.AppIsSSLEnabled, value);
			}
		}
		...
		public virtual string s_AppDisplayMenu
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.AppDisplayMenu) ? string.Empty : base.GetstringAsString(ColumnNames.AppDisplayMenu);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.AppDisplayMenu);
				else
					this.AppDisplayMenu = base.SetstringAsString(ColumnNames.AppDisplayMenu, value);
			}
		}

		public virtual string s_AppIsSSLEnabled
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.AppIsSSLEnabled) ? string.Empty : base.GetboolAsString(ColumnNames.AppIsSSLEnabled);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.AppIsSSLEnabled);
				else
					this.AppIsSSLEnabled = base.SetboolAsString(ColumnNames.AppIsSSLEnabled, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter AppDisplayMenu
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.AppDisplayMenu, Parameters.AppDisplayMenu);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}

				public WhereParameter AppIsSSLEnabled
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.AppIsSSLEnabled, Parameters.AppIsSSLEnabled);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter AppDisplayMenu
		    {
				get
		        {
					if(_AppDisplayMenu_W == null)
	        	    {
						_AppDisplayMenu_W = TearOff.AppDisplayMenu;
					}
					return _AppDisplayMenu_W;
				}
			}
			...
			public WhereParameter AppIsSSLEnabled
		    {
				get
		        {
					if(_AppIsSSLEnabled_W == null)
	        	    {
						_AppIsSSLEnabled_W = TearOff.AppIsSSLEnabled;
					}
					return _AppIsSSLEnabled_W;
				}
			}
			...
			private WhereParameter _AppDisplayMenu_W = null;
			private WhereParameter _AppIsSSLEnabled_W = null;
			...
			public void WhereClauseReset()
			{
				...
				_AppDisplayMenu_W = null;
				_AppIsSSLEnabled_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter AppDisplayMenu
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.AppDisplayMenu, Parameters.AppDisplayMenu);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}

				public AggregateParameter AppIsSSLEnabled
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.AppIsSSLEnabled, Parameters.AppIsSSLEnabled);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _AppDisplayMenu_W = null;
			private AggregateParameter _AppIsSSLEnabled_W = null;
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.AppDisplayMenu);
			p.SourceColumn = ColumnNames.AppDisplayMenu;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.AppIsSSLEnabled);
			p.SourceColumn = ColumnNames.AppIsSSLEnabled;
			p.SourceVersion = DataRowVersion.Current;
